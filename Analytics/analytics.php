<?php
    ...
    $links=$shortLinkService->getUserLinks((int)$user['link_id']);
    ...
    $clickByDevice=$clickTrackingService->getClicksByDevice($linkId);
    ?>
...
<body>
    ...
    <p>
        ...
        <a href="/<? htmlspecialchars($currentLink['short_code'])?>" target="_blank">/<? htmlspecialchars($currentLink['short_code'])?></a>
    </p>

    <p>
        <strong>Original URL</strong>
        <a href="/<? htmlspecialchars($currentLink['original_url'])?>" target="_blank">/<? htmlspecialchars($currentLink['original_url'])?></a>
    </p>
